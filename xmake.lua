...
add_repositories("vcpkg::x64-windows-static")
add_requires("vcpkg::protobuf")
add_requires("vcpkg::boost-asio")
add_requires("vcpkg::boost-bind")
add_requires("vcpkg::boost-system")

target("ap")
    add_rules("qt.widgetapp")
    add_packages("vcpkg::protobuf")
    add_packages("vcpkg::boost-asio")
    add_packages("vcpkg::boost-bind")
